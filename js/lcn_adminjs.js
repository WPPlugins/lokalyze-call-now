jQuery(document).ready(function($){
	...
	$( ".lokalyze-save-callnowbutton" ).click(function(){
		...
		var data = { 'action': 'savecallnowbutton', 'clbtstus': call_but_status, 'clbtnum': call_but_number, 'clbtclr': call_but_color, 'clbtapp': call_but_appear, 'clbtcltrk': call_but_cltrck, 'clbttrkcod': call_but_trkcode };
